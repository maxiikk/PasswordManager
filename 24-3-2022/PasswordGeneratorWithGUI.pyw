...
decryptbutton.set("Decrypt")
b2 = Button(master , textvariable = savebutton, command = savetofile1, bg='white', borderwidth = 5).grid(row = 5, column = 3, ipadx = 1, stick = W)
b5 = Button(master , textvariable = copybutton, command = copy5, bg='white', borderwidth = 5).grid(row = 5, column = 4, ipadx = 1, stick = W)
b3 = Button(master, textvariable = decryptbutton, command = decrypt1, bg='white', borderwidth = 5).grid(row = 6, column = 3, ipadx = 1, stick = W)
b4 = Button(master, textvariable = copybutton, command = copy1, bg='white', borderwidth = 5).grid(row = 9, column = 3, ipadx = 1, stick = W)
b6 = Button(master, textvariable = copybutton, command = copy3, bg='white', borderwidth = 5).grid(row = 4, column = 3, ipadx = 1, stick = W)
...
Last edit made at 24/3/2022 20:31
"""
